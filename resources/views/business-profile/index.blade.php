...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive m-t-40 ">
            ...
            <div style="display:flex; align-items:center;  flex-wrap: wrap; justify-content: space-between; margin-bottom: 20px; margin-top:50px;">
            ...
            <!-- <form id="filter-form" style="display:flex; align-items:center;  flex-wrap: wrap; justify-content: space-between; margin-bottom: 0px;">
                <div class="d-flex">                    
                    ...
                    <input type="date" id="date"class="me-2 form-control"   name="date"  style="width:80%;">
...
<script type="text/javascript">
    ...
    $(function () {
        setTimeout(function () {
        var table = $('.profile-listing').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
